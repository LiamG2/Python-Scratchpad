...
with st.sidebar:  
    st_lottie(lottie_polyfox_1, height=300, key='polyfox_1')
...
with col1:
    ...
    st_lottie(lottie_polyfox_1, height=300, key="polyfox_2")
    # note different 'key' name above, needed when using same animation
    # \multiple times
...
with col2:
    ...
    st_lottie(lottie_polyfox_1, height=300, key='polyfox_3')
    # note different 'key' name above, needed when using same animation
    # \multiple times
